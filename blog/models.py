...
#     user = models.ForeignKey(User, on_delete=models.CASCADE, related_name="userupvote")
#     post = models.ForeignKey(Post, on_delete=models.CASCADE, related_name="postupvote")


# class Downvote(models.Model):
#     user = models.ForeignKey(User, on_delete=models.CASCADE, related_name="userdownvote")
#     post = models.ForeignKey(Post, on_delete=models.CASCADE, related_name="postdownvote")
